...
class UserAPI:
    ...
    def get_info(self, username):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get user info for {username}.")
    ...
    def get_top_artists(self, username):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get top artists for {username}.")
    ...
    def get_recent_tracks(self, username):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get recent tracks for {username}.")
    ...
    def get_top_tracks(self, username):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get top tracks for {username}.")
