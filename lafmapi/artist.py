...
class ArtistAPI:
    ...
    def get_info(self, artist_name):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get artist info for {artist_name}.")
    ...
    def get_top_tracks(self, artist_name):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get top tracks for {artist_name}.")
    ...
    def get_top_albums(self, artist_name):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get top albums for {artist_name}.")
    ...
    def search(self, query):
        ...
        try:
            ...
            raise LastfmError(f"No results found for {query}.")
    ...
    def get_similar_artists(self, artist_name):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get similar artists for {artist_name}.")
