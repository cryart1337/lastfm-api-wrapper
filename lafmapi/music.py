...
class MusicAPI:
    ...
    def search_track(self, track_name):
        ...
        try:
            ...
            raise LastfmError(f"No results found for {track_name}.")
    ...
    def get_track_info(self, track_name, artist_name):
        ...
        try:
            ...
            raise LastfmError(f"Failed to get track info for {track_name} by {artist_name}.")
    ...
    def get_lyrics(self, track_name, artist_name):
        ...
        try:
            ...
            raise LastfmError(f"No lyrics found for {track_name} by {artist_name}.")
